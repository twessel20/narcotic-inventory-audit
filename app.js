...
function unitAuditSection(a,loc,index){
 ...
 return '<section class="audit-card unit-audit-card" data-unit-section="'+esc(loc)+'"><div class="unit-audit-head"><div><span class="kicker">LOCATION '+(index+1)+' OF '+LOCS.length+'</span><h3>'+esc(loc)+'</h3><p class="meta">Complete this location before moving to the next.</p></div><span class="unit-step-badge">'+esc(loc)+'</span></div>'+
 '<div class="unit-subsection"><h4>1. Physical inventory</h4><p class="meta">Compare the previous finalized audit with the count physically verified today.</p><div class="unit-med-list">'+medRows+'</div></div>'+
 '<div class="unit-subsection"><h4>2. Breakaway tags</h4><div class="tag-entry-fields"><label>Tag found / removed<input inputmode="numeric" autocomplete="off" placeholder="Enter removed tag #" data-tag-loc="'+loc+'" data-tag-kind="foundRemoved" aria-label="'+loc+' tag found or removed" value="'+esc(tag.foundRemoved||'')+'"></label><label>New tag installed<input inputmode="numeric" autocomplete="off" placeholder="Enter new tag #" data-tag-loc="'+loc+'" data-tag-kind="newInstalled" aria-label="'+loc+' new tag installed" value="'+esc(tag.newInstalled||'')+'"></label></div></div>'+
 '<div class="unit-subsection"><h4>3. Certification</h4><p class="meta">Signer certifies the count and seal entries. Witness verifies the count and seal record.</p>'+sigBlock(loc,sig,true)+'</div>'+
 '</section>';
}
